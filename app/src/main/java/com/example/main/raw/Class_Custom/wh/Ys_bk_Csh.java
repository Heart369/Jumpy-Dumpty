...
public class Ys_bk_Csh extends Thread {
    ...
    public void run() {
        super.run();
        String[] jsname = new String[]{"达达利亚", "神里绫人", "可莉", "迪奥娜", "安柏", "芭芭拉", "砂糖", "迪卢克", "莫娜", "琴", "优菈", "班尼特", "诺艾尔", "雷泽", "阿贝多", "温迪", "菲谢尔", "罗莎莉亚", "凯亚", "丽莎", "刻晴", "七七", "申鹤", "夜兰", "魈", "凝光", "枫原万叶", "甘雨", "胡桃", "重云", "香菱", "云堇", "瑶瑶", "钟离", "行秋", "辛焱", "烟绯", "北斗", "珊瑚宫心海", "宵宫", "托马", "鹿野院平藏", "荒泷一斗", "神里绫华", "埃洛伊", "久岐忍", "九条裟罗", "八重神子", "雷电将军", "早柚", "五郎", "赛诺", "提纳里", "坎蒂丝", "珐露珊", "艾尔海森", "纳西妲", "多莉", "流浪者", "妮露", "柯莱", "迪希雅", "米卡","白术","卡维","莱依拉","绮良良"};
        int cz = 0;
        ...
        for (String name:jsname) {
            ...
            try {
                ...
                values.put("icon", date.getImages().getIcon());
