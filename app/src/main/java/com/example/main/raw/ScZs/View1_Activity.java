    ...
    public void csh(View view, Context context, LayoutInflater layoutInflater,int i){
        ...
        switch (i){
            case 1:
                ...
                recy_Adpter_zs adpter = new recy_Adpter_zs(4,context,1);
                recyclerView1.setAdapter(adpter);

                layoutManager =new LinearLayoutManager(context);
                layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView2.setLayoutManager(layoutManager);
                recy_Adpter_zs adpter_wq = new recy_Adpter_zs(4,context,4);
            ...
            case 2:
                ...
                layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView1.setLayoutManager(layoutManager);
                recy_Adpter_zs adpter1 = new recy_Adpter_zs(4,context,2);
                ...
                layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView2.setLayoutManager(layoutManager);
                recy_Adpter_zs adpter_wq1 = new recy_Adpter_zs(4,context,5);
            ...
            case 3:
                ...
                layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView1.setLayoutManager(layoutManager);
                recy_Adpter_zs adpter2 = new recy_Adpter_zs(4,context,3);
                recyclerView1.setAdapter(adpter2);

                layoutManager =new LinearLayoutManager(context);
                layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView2.setLayoutManager(layoutManager);
                recy_Adpter_zs adpter_wq2 = new recy_Adpter_zs(4,context,6);
            ...
            case 4:
                ...
                layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView1.setLayoutManager(layoutManager);
                recy_Adpter_zs adpter3 = new recy_Adpter_zs(12,context,7);
                recyclerView1.setAdapter(adpter3);

                layoutManager =new LinearLayoutManager(context);
                layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                recyclerView2.setLayoutManager(layoutManager);
                recy_Adpter_zs adpter_wq3 = new recy_Adpter_zs(12,context,8);
