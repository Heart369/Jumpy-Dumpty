...
public class view1_Activity extends AppCompatActivity {
    ...
    int[] layout = {R.layout.new_bq, R.layout.cailiao_item, R.layout.cailiao_item, R.layout.cailiao_item, R.layout.cailiao_item};
    ...
    private void initData() {
        ...
        switch (week) {
            ...
            case "Mo":
                ...
                Bqdata xmdata = new Bqdata("谨言的哲学", "谧林涓露的金符", "须弥今日素材", R.drawable.xmi, R.drawable.xm_jy, R.drawable.xm_jf);
                bqdata.add(mddata);
                bqdata.add(lydata);
                bqdata.add(dqdata);
                bqdata.add(xmdata);
