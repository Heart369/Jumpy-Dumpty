...
public class requestdata extends Thread {
    ...
    public void run1(String url,String cookie, String uid,String server) throws IOException {
        ...
        Request getRequest = new Request.Builder()
                ...
                .header("x-rpc-app_version","2.51.1")
                .header("User-Agent","Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) miHoYoBBS/2.51.1")
                .header("DS",ds_main.getDS())
                .header("Host","api-takumi-record.mihoyo.com")
                .header("x-rpc-client_type","5")
                .header("x-rpc-device_fp","38d7eeb3cb5e7")
                .header("x-Rpc-Device_id","6bdc7e35-60db-434c-9ccf-90e846946c30")
